package roman.lesson_11.day_6.task_36_37;
...
public class BookDatabaseImpl implements BookDatabase {
    ...
    public Map<String, List<Book>> getAuthorToBooksMap() {
        ...
        for (String author : findUniqueAuthors()) {
            authorsToBookMap.put(author, find(new AuthorSearchCriteria(author)));
        }
    ...
    public Map<String, Integer> getEachAuthorBookCount() {
        Map<String, Integer> mapEachAuthorBookCount = new HashMap<>();
        for (String author : findUniqueAuthors()) {
            mapEachAuthorBookCount.put(author, find(new AuthorSearchCriteria(author)).size());
        }
        return mapEachAuthorBookCount;
    }
