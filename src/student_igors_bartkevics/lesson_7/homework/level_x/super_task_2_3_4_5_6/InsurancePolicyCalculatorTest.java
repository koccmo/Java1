...
class InsurancePolicyCalculatorTest {
    ...
    //Super_task_3
    public void containsRiskTypeTest() {
        SubInsuranceObject notebook = new SubInsuranceObject("Notebook", new BigDecimal("5000.00"), RiskType.FIRE);
        boolean condition1 = !notebook.containsRiskType(RiskType.THIEF);
        boolean condition2 = notebook.containsRiskType(RiskType.FIRE);
        checkResult(condition1, "Does not contain risk type test");
        checkResult(condition2, "Contains risk type test");
    }
