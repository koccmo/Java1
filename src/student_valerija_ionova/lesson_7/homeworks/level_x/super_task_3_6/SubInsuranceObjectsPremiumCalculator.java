...
public class SubInsuranceObjectsPremiumCalculator {
	...
	private FloodRiskCoefficientDetector floodRiskCoeficientDetector = new FloodRiskCoefficientDetector();
	...
	private BigDecimal getCoeficientForSubInsuranceObjects(InsuranceRisk insuranceRisk,
		...
		if (InsuranceRisk.FLOOD == insuranceRisk) {
			return floodRiskCoeficientDetector.detect(insuranceObject.getSubInsuranceObjects());
		}
