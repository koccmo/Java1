...
public class BookReaderImpl implements BookReader{
    ...
    @Override
    public List<Book> getListOfBookBuyTitle(String bookTitle) {
        List<Book> listOfBookWithSameTitle = new ArrayList<>();
        library.forEach(book -> {
            if(book.getTitle().equals(bookTitle)) {
                listOfBookWithSameTitle.add(book);
            }
        });
        return listOfBookWithSameTitle;
    }
}
