...
class LearningGridBagLayout {
    ...
    public static void main (String [] args) throws Exception{
        ...
        constraints1.weightx = 0;    //Сам растягивается, если =0
        ...
        constraints2.weightx = 0;    //Сам растягивается, если =0
        ...
        constraints3.weightx = 0;    //Сам растягивается, если =0
        ...
        constraints4.weightx = 0;    //Сам растягивается, если =0
