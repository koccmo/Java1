...
class BookReaderImplTest {
    ...
    public static void main(String[] args) {
        ...
        test.findBooksWhichTitleStartsWithStringPositiveTest();
        test.findBooksWhichTitleStartsWithStringNegativeTest();
        test.findBooksWhichTitleStartsWithStringNoLettersTest();
        test.markBookAsReadPositiveTest();
        test.markBookAsReadNegativeTest();
        test.markBookAsUnreadPositiveTest();
        test.markBookAsUnreadNegativeTest();
        test.getListOfReadBooksPositiveTest();
        test.getListOfReadBooksNegativeTest();
        test.getListOfUnreadBooksPositiveTest();
        test.getListOfUnreadBooksNegativeTest();
    }
    ...
    void findBooksWhichTitleStartsWithStringPositiveTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        boolean condition = bookReader.findBooksWhichTitleStartsWithString("Clean").equals(booksByAuthor);
        checkResult(condition, "Find books which title starts with string several books positive");
    }

    void findBooksWhichTitleStartsWithStringNegativeTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        boolean condition = bookReader.findBooksWhichTitleStartsWithString("Po").equals(booksByAuthor);
        checkResult(condition, "Find books which title starts with string negative");
    }

    void findBooksWhichTitleStartsWithStringNoLettersTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        boolean condition = bookReader.findBooksWhichTitleStartsWithString("").equals(booksByAuthor);
        checkResult(condition, "Find books which title starts with string No letters");
    }

    void markBookAsReadPositiveTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        boolean condition = bookReader.markBookAsRead(book2) && book2.getIsReadState();
        checkResult(condition, "Mark book as read positive");
    }

    void markBookAsReadNegativeTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book5);
        boolean condition = !bookReader.markBookAsRead(book2) && !book2.getIsReadState();
        checkResult(condition, "Mark book as read negative");
    }

    void markBookAsUnreadPositiveTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        boolean condition = bookReader.markBookAsUnread(book2) && !book2.getIsReadState();
        checkResult(condition, "Mark book as unread positive");
    }

    void markBookAsUnreadNegativeTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        boolean condition = !bookReader.markBookAsUnread(book2);
        checkResult(condition, "Mark book as unread negative");
    }

    void getListOfReadBooksPositiveTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.markBookAsRead(book5);
        String[] readBooks = {"Clean Code - A Handbook of Agile Software Craftsmanship [Martin R.]", "Clean Code - A Handbook of Agile Software Craftsmanship rev 3 [Martin R.]"};
        boolean condition = Arrays.equals(bookReader.getListOfReadBooks(), readBooks);
        checkResult(condition, "Get list of read books positive");
    }

    void getListOfReadBooksNegativeTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        String[] readBooks = new String[0];
        boolean condition = Arrays.equals(bookReader.getListOfReadBooks(), readBooks);
        checkResult(condition, "Get list of read books negative");
    }

    void getListOfUnreadBooksPositiveTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.markBookAsRead(book2);
        bookReader.markBookAsRead(book5);
        String[] unreadBooks = {"Head First Java [Bates B., Sierra K.]",
                "The Pragmatic Programmer. From Journeyman to Master [Hunt A., Thomas D.]",
                "Clean Code - A Handbook of Agile Software Craftsmanship rev 2 [Martin R.]"};
        boolean condition = Arrays.equals(bookReader.getListOfUnreadBooks(), unreadBooks);
        checkResult(condition, "Get list of unread books positive");
    }

    void getListOfUnreadBooksNegativeTest() {
        Book book1 = new Book("Bates B., Sierra K.", "Head First Java");
        Book book2 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship");
        Book book3 = new Book("Hunt A., Thomas D.", "The Pragmatic Programmer. From Journeyman to Master");
        Book book4 = new Book("Martin R.", "Clean Code - A Handbook of Agile Software Craftsmanship rev 2");
        ...
        bookReader.addBook(book4);
        bookReader.addBook(book5);
        bookReader.markBookAsRead(book1);
        bookReader.markBookAsRead(book2);
        bookReader.markBookAsRead(book3);
        bookReader.markBookAsRead(book4);
        bookReader.markBookAsRead(book5);
        String[] unreadBooks = new String[0];
        boolean condition = Arrays.equals(bookReader.getListOfUnreadBooks(), unreadBooks);
        checkResult(condition, "Get list of unread books negative");
    }
