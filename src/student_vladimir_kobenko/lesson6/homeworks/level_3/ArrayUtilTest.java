package student_vladimir_kobenko.lesson6.homeworks.level_3;
...
public class ArrayUtilTest {
    ...
    public void ifContainsNumber() {
        ArrayUtil arrayUtil = new ArrayUtil();
        int[] array = {1, 3, 5, 7, 8, 0};
        boolean testResult = arrayUtil.ifContainNumber(8, array);
        if (testResult = true) {
            System.out.println("If contain number test is Ok");
        } else {
            System.out.println("If contain number test is failed");
        }
    }
}
