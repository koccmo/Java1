 ...
 */
package student_igors_bartkevics.lesson_4.homeworks.day_x.super_task_3;
...
class CalculatorTest {
    ...
    public void checkResultBool(String testName, boolean result) {
        if (result) {
            System.out.println(testName + " test = OK");
        } else {
            System.out.println(testName + " test = FAIL");
    ...
    public void sumTest() {
        ...
        Calculator calculator = new Calculator();
        int result = calculator.sum(firstNumber, secondNumber);
        checkResultInt(testName, result, expectedResult);
    }
    ...
    public void isEvenTest() {
        ...
        checkResultBool(testName, result);
