...
public class EntertainmentExpensesCalculator {
    ...
    public int calculateExpensesAmount(BankAccount bankAccount) {
        ...
        List<Transaction> transactionsWithExpenseCategoryEntertainment = selectTransactionsWithExpenseCategoryEntertainment(withdrawalTransactions);
    ...
    private List<Transaction> selectTransactionsWithExpenseCategoryEntertainment(List<Transaction> withdrawalTransactions) {
        List<Transaction> transactionsWithExpenseCategoryEntertainment = new ArrayList<>();
        for (Transaction transaction : withdrawalTransactions) {
            if (transaction.getExpenseCategory() == ExpenseCategory.ENTERTAINMENT) {
                transactionsWithExpenseCategoryEntertainment.add(transaction);
            }
        }
        return transactionsWithExpenseCategoryEntertainment;
    }
