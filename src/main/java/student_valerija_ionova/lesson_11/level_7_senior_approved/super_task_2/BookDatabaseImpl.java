...
public class BookDatabaseImpl implements BookDatabase {
    ...
    @Override
    public List<Book> find(List <SearchCriteria>searchCriteria, Paging paging, SortingAlgoritm sortingAlgoritm) {
        ...
        books = sortingAlgoritm.sortList(books);

        if (paging.getPagingIndicated() && (books.size()>0)){
            books = paging.getCorrectPage(books);
        }
