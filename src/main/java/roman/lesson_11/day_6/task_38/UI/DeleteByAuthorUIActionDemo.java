...
public class DeleteByAuthorUIActionDemo {
    public static void main(String[] args) {
        ...
        DeleteByAuthorUIAction deleteByAuthorUIAction = new DeleteByAuthorUIAction(bookDatabase);
        deleteByAuthorUIAction.execute();

        System.out.println("In Library is " + bookDatabase.countAllBooks() + " books!");
    }
}
